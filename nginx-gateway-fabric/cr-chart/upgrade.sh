...
# ============================================================
SCRIPT_NAME="nginx-gateway-cr Helm Chart Upgrade Script"
HELM_REPO_NAME="somaz94"
HELM_REPO_URL="https://charts.somaz.blog"
HELM_CHART="somaz94/nginx-gateway-cr"
CHANGELOG_URL="https://github.com/somaz94/helm-charts/releases?q=nginx-gateway-cr"
